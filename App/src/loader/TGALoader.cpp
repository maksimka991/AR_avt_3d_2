...
namespace NApp
{
   ...
   bool TGALoader::LoadTGA(Texture * texture, const char * filename)				// Load a TGA file
	{
   ...
   bool TGALoader::LoadUncompressedTGA(Texture * texture, const char * filename, FILE * fTGA)	// Load an uncompressed TGA (note, much of this code is based on NeHe's
   ...
   bool TGALoader::LoadCompressedTGA(Texture * texture, const char * filename, FILE * fTGA)		// Load COMPRESSED TGAs
	{
